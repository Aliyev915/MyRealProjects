...
class ProjectController extends Controller
{
    ...
    public function store(Request $request){
        ...
        return redirect('/admin-user/project')->with('success_message','Succesfully added!');
    }
    ...
    public function update($id,Request $request){
        ...
        if($request->image!=null){
            if (File::exists(public_path() . '/storage/images/projects/' . $project->image)) {
                File::delete(public_path() . '/storage/images/projects/' . $project->image);
            }
            $image = $request->file('image');
            $path = $this->fileUpload($image);
            $project->image = $path;
        ...
        return redirect('/admin-user/project')->with('success_message','Succesfully updated!');
    }
    ...
    public function delete($id){
        ...
        $project->delete();
        return redirect('/admin-user/project')->with('success_message','Succesfully deleted!');
    }
    ...
    public function fileUpload($image)
    {
        ...
        $image->move(public_path('storage/images/projects'),$path);
        return $path;
    }
}
