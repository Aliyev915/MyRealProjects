            ...
            <div class="container2">
                <div class="azerbaycan">
                    <div style="margin-top: 170px;" class="content nant-content">
                        ...
                        <br>
                        {{-- <p>
                            "NANT" MMC 2002-ci ildə təsis olunmuşdur. Şirkətimizin əsas profili ərzaq məhsullarının Azərbaycana idxalı və distribusiyasıdır. NANT MMC Rusiyanın, Indoneziyanın, Cənub Koreyanın, Yunanıstanın, Ukraynanın, aparıcı istehsal şirkətlərinin rəsmi distribyutorudur.Məqsədimiz idxal etdiyimiz məhsulları Azərbaycanın bütün bölgələrində yerləşən hər bir satış nöqtəsinə çatdırmaqdır. Bunun ücün güclü satış və merçendayzing komandamız mövcuddur.
                        </p> --}}
                            ...
                            <div class="melumat" style="flex-wrap: wrap">
                                    @foreach ($region->districts as $district)
                                        <div class="col-md-12" style="width: 33%">
                                            <p><i class="fas fa-check-circle"></i><span class="müdir">{{ $district->name_az }}</span></p>
                                        </div>
                                    @endforeach
                            </div>
