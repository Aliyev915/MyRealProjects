        ...
        <div class="card">
            <div class="card-body">
                <div class="row justify-content-between">
                    ...
                    <a href="{{ route('create-contact') }}" class="btn btn-success mr-3">Create</a>
                </div>
                </p>
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            @foreach ($contacts as $contact)
                                <tr>
                                    <th>{{ $contact->id }}</th>
                                    <td>{{ $contact->{'position_'.App::getLocale()} }}</td>
                                    <td>{{ $contact->{'fullname_'.App::getLocale()} }}</td>
                                    <td>{{ $contact->email }}</td>
                                    <td>
                                        <a href="/admin-user/contact/edit/{{ $contact->id }}"
                                            class="btn btn-primary mr-2"><i class="mdi mdi-table-edit"></i></a>
                                        <a href="/admin-user/contact/delete/{{ $contact->id }}"
