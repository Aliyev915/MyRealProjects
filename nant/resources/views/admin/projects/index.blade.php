        ...
        <div class="card">
            <div class="card-body">
                <div class="row justify-content-between">
                    ...
                    <a href="{{ route('create-project') }}" class="btn btn-success mr-3">Create</a>
                </div>
                </p>
                        ...
                        <tbody>
                            @foreach ($projects as $project)
                                <tr>
                                    ...
                                    <td>
                                        @if(Str::length($project->{'description_' . App::getLocale()})>50)
                                            {{ Str::substr($project->{'description_' . App::getLocale()},0,50) }}...
                                            @else
                                    ...
                                    <td>
                                        <a href="/admin-user/project/edit/{{ $project->id }}"
                                            class="btn btn-primary mr-2"><i class="mdi mdi-table-edit"></i></a>
                                        <a href="/admin-user/project/delete/{{ $project->id }}"
