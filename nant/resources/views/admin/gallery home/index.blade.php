        ...
        <div class="card">
            <div class="card-body">
                <div class="row justify-content-between">
                    ...
                    <a href="{{ route('create-gallery-home') }}" class="btn btn-success mr-3">Create</a>
                </div>
                </p>
                        ...
                        <tbody>
                            @foreach ($galleries as $gallery)
                                <tr>
                                    ...
                                    <td>
                                        <a href="/admin-user/gallery-home/edit/{{ $gallery->id }}"
                                            class="btn btn-primary mr-2"><i class="mdi mdi-table-edit"></i></a>
                                        <a href="/admin-user/gallery-home/delete/{{ $gallery->id }}"
