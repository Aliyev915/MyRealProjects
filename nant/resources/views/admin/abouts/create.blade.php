            ...
            <div class="card-body">
                ...
                <form class="forms-sample" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputEmail3" name="title_en"
                            placeholder="Title" />
                        @error('title_en')
                            <div class="text-danger my-3">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputEmail3" name="title_ru"
                            placeholder="Title" />
                        @error('title_ru')
                            <div class="text-danger my-3">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="summary-ckeditor2" name="description_az"
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="summary-ckeditor" name="description_en"
                            placeholder="Description"></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="summary-ckeditor1" name="description_ru"
                            placeholder="Description"></textarea>
