        ...
        <div class="card">
            <div class="card-body">
                <div class="row justify-content-between">
                    ...
                    <a href="<?php echo e(route('create-gallery-home')); ?>" class="btn btn-success mr-3">Create</a>
                </div>
                </p>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $galleries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gallery): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="/admin-user/gallery-home/edit/<?php echo e($gallery->id); ?>"
                                            class="btn btn-primary mr-2"><i class="mdi mdi-table-edit"></i></a>
                                        <a href="/admin-user/gallery-home/delete/<?php echo e($gallery->id); ?>"
