        ...
        <div class="card">
            <div class="card-body">
                <div class="row justify-content-between">
                    <h3 class="card-title ml-3">Vacancies</h3>
                    <a href="<?php echo e(route('create-vacancy')); ?>" class="btn btn-success mr-3">Create</a>
                </div>
                </p>
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $vacancies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vacancy): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <th><?php echo e($vacancy->id); ?></th>
                                    <td><?php echo e($vacancy->{'position_' . App::getLocale()}); ?></td>
                                    <td><?php echo e($vacancy->company); ?></td>
                                    <td>
                                        <?php echo e($vacancy->region->{'name_' . App::getLocale()}); ?>

                                    </td>
                                    <td>
                                        <a href="/admin-user/vacancy/edit/<?php echo e($vacancy->id); ?>"
                                            class="btn btn-primary mr-2"><i class="mdi mdi-table-edit"></i></a>
                                        <a href="/admin-user/vacancy/delete/<?php echo e($vacancy->id); ?>"
