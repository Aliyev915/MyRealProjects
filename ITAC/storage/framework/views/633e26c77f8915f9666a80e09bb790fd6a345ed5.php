        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="offset-md-3 col-md-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title" style="text-align:center">Register Form</h4>
                    <p class="card-description" style="text-align: center">Register form layout</p>
                    ...
                    <form class="forms-sample" method="POST">
                      ...
                      <div class="form-group ">
                        <label for="exampleInputUsername2" >Fullname</label>
                        <div >
                          <input type="text" class="form-control" id="exampleInputUsername2" placeholder="Fullname" name="fullname" />
                        </div>
...
unset($__errorArgs, $__bag); ?>
                      ...
                      <div class="form-group ">
                        <label for="exampleInputConfirmPassword2" >Repeat Password</label>
                        <div>
                          <input type="password" class="form-control" id="exampleInputConfirmPassword2" placeholder="Password" name="repeat_password"/>
                        </div>
...
<?php /**PATH C:\xampp\htdocs\ITAC\resources\views/auth/register.blade.php ENDPATH**/ ?>