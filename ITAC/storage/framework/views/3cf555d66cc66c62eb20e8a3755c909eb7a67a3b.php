<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <div class="text-center sidebar-brand-wrapper d-flex align-items-center">
      <a class="sidebar-brand brand-logo" href="index.html"><img src="<?php echo e(asset('admin/assets/images/logo.svg')); ?>" alt="logo" /></a>
      <a class="sidebar-brand brand-logo-mini pl-4 pt-3" href="index.html"><img src="<?php echo e(asset('admin/assets/images/logo-mini.svg')); ?>" alt="logo" /></a>
    </div>
    <ul class="nav">
      <li class="nav-item nav-profile">
        <a href="#" class="nav-link">
          <div class="nav-profile-image">
            <img src="<?php echo e(asset('admin/assets/images/faces/face1.jpg')); ?>" alt="profile" />
            <span class="login-status online"></span>
            <!--change to offline or busy as needed-->
          </div>
          <div class="nav-profile-text d-flex flex-column pr-3">
            <span class="font-weight-medium mb-2"><?php echo e(Auth::user()->fullname); ?></span>
          </div>
        </a>
      </li>
      <li class="nav-item">
...
<?php /**PATH C:\xampp\htdocs\ITAC\resources\views/admin/layouts/sidebar.blade.php ENDPATH**/ ?>