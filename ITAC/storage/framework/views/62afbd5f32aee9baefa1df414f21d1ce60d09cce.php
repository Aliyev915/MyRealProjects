                ...
                <div class="col-xl-6 offset-xl-3 col-lg-8 offset-lg-2">
                    <div class="poster-content">
                        ...
                        <div class="poster-navigation">
                            <ul>
                                <li><a href="#">Home</a></li>
                                <li><a class="active" href="#"><?php echo e($data); ?></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ITAC\resources\views/blog.blade.php ENDPATH**/ ?>