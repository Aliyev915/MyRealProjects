                    ...
                    <form class="forms-sample" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputName1" name="name_az" placeholder="Name"
                                value="<?php echo e($company->name_az); ?>" />
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputName1" name="name_en" placeholder="Name"
                                value="<?php echo e($company->name_en); ?>" />
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputName1" name="name_ru" placeholder="Name"
                                value="<?php echo e($company->name_ru); ?>" />
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row">
                            <img src="<?php echo e(asset('storage/images/companies/' . $company->image)); ?>" width="200" height="250"
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ITAC\resources\views/admin/companies/edit.blade.php ENDPATH**/ ?>